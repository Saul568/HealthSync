...
import '/components/medicine_alert/medicine_alert_widget.dart';
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 30.0, 16.0, 0.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    15.0, 0.0, 0.0, 0.0),
                                            child: Image.network(
                                              'https://www.iconpacks.net/icons/2/free-medicine-icon-3260-thumb.png',
                                              width: 60.0,
                                              height: 60.0,
                                              fit: BoxFit.cover,
                                            ),
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  8.0),
                                                      child: AutoSizeText(
                                                        'Amidst daily tasks, don\'t overlook your medications. Consistency is vital. Prioritize your health and never miss a dose. ',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodySmall
