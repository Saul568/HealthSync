...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'covid',
          path: '/covid',
          builder: (context, params) => CovidWidget(),
        ),
        FFRoute(
          name: 'diabetes',
          path: '/diabetes',
        ...
        FFRoute(
          name: 'Influenza',
          path: '/influenza',
          builder: (context, params) => InfluenzaWidget(),
        ),
        FFRoute(
          name: 'Hypertension',
          path: '/hypertension',
          builder: (context, params) => HypertensionWidget(),
        ),
        FFRoute(
          name: 'Asthma',
          path: '/asthma',
          builder: (context, params) => AsthmaWidget(),
        ),
        FFRoute(
          name: 'Commoncold',
          path: '/commoncold',
          builder: (context, params) => CommoncoldWidget(),
        )
